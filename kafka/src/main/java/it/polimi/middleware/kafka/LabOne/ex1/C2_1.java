...
public class C2_1 {
    ...
    private static final String defaultInputTopic = "ex_1";
    private static final String defaultOutputTopic = "ex_1_result";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (final ConsumerRecord<String, String> record : records) {
                ...
                System.out.println("New message sent id: "+record.key()+" val: "+newValue);
            }
        }
    }
}